%% SpaceKinova_CDR.m
% CDR mit Randomisierung pro Episode. Ohne parametrisiertes Modell wirkt nur CDR-1 (Trajektorie).
...
cfg.mdl        = "SpaceKinova_MotionProfile_40Hz";   % 40-Hz-Variante (Rate Transitions 0.025 s)
