...
%   - Simulink-Modell mit konstantem EE_ref (Startpose = Integrator-IC im Modell)
...
% target_pos = [0.613; -0.022; 1.089]; % Test vom 24.06.2026
target_pos = [0.479; -0.005; 1.136];   % Paper (Table V)
target_R   = eye(3);
...
%  4) AGENT LADEN
%  =========================
agentFile = sk_path('SavedAgents/MotionProfile/point/test_agent_rand2.mat');
...
try
    ...
    save(sk_path('data', 'dq_cmd', 'dq_cmd_point.mat'), 't_dq', 'dq', 'target_pos');
